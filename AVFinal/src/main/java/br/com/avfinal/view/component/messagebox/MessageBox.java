package br.com.avfinal.view.component.messagebox;
...
public class MessageBox {
    ...
    public static int show(final Window parent, final String message, final String title, final int option) {
...

        {
            ...
            final String[] BUTTON_STRING_LIST = new String[] {"OK", "Sim", "N\u00e3o","Abortar", "Repetir", "Ignorar", "Cancelar"};
            ...
            totalPane.getChildren().add(new Label(""));
        }
