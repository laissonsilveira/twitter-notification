var store = function () {
    ...
    var p;
    try {
        p = "localStorage" in g && g.localStorage
    } catch (i) {
        p = false
    }
    if (p) {
        f = g.localStorage;
        b.set = function (a, c) {
            f.setItem(a, b.serialize(c))
        };
        b.get = function (a) {
            return b.deserialize(f.getItem(a))
        };
        b.remove = function (a) {
            f.removeItem(a)
        };
        ...
        var n;
        try {
            n = "globalStorage" in g && g.globalStorage && g.globalStorage[g.location.hostname]
        } catch (r) {
            n = false
        }
        if (n) {
            f = g.globalStorage[g.location.hostname];
            b.set = function (a, c) {
                f[a] = b.serialize(c)
            };
            b.get = function (a) {
                return b.deserialize(f[a] && f[a].value)
            };
            b.remove = function (a) {
                delete f[a]
            };
            ...
            if (m.documentElement.addBehavior) {
                ...
                g = function (a) {
                    return function () {
                        ...
                        f.load("localStorage");
                        c = a.apply(b, c);
                        m.body.removeChild(f);
                        return c
                    }
                };
                b.set = g(function (a, c, d) {
                    a.setAttribute(c, b.serialize(d));
                    a.save("localStorage")
                });
                b.get = g(function (a, c) {
                    return b.deserialize(a.getAttribute(c))
                });
                b.remove = g(function (a, c) {
                    a.removeAttribute(c);
                    a.save("localStorage")
                });
                b.clear = g(function (a) {
                    var c = a.XMLDocument.documentElement.attributes;
                    a.load("localStorage");
    ...
    try {
        ...
        if (b.get("__storejs__") != "__storejs__") {
            b.disabled = true
        }
...
(function () {
    ...
    var f = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, p = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, i, n, r = {
        "\u0008": "\\b",
        "\t": "\\t",
        "\n": "\\n",
        "\u000c": "\\f",
